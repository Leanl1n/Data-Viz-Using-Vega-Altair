...
CONFIG_PATH = os.path.join(PROJECT_ROOT, DEFAULT_DATA_DIR, CONFIG_FILENAME)
...
EXECUTIVE_SUMMARY_PATH = os.path.join(PROJECT_ROOT, DEFAULT_DATA_DIR, EXECUTIVE_SUMMARY_FILENAME)
EXECUTIVE_SUMMARY_JSON_FILENAME = "executive_summary.json"
EXECUTIVE_SUMMARY_JSON_PATH = os.path.join(PROJECT_ROOT, DEFAULT_DATA_DIR, EXECUTIVE_SUMMARY_JSON_FILENAME)
DASHBOARD_CSS_FILENAME = "dashboard.css"
DASHBOARD_CSS_PATH = os.path.join(PROJECT_ROOT, DEFAULT_DATA_DIR, DASHBOARD_CSS_FILENAME)
